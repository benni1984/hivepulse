  ...
  return (
    <>
      <section className="help-section">
        ...
        <Screenshot android="/docs/screenshots/android-hive-stats.png" web="/docs/screenshots/hive-stats-overview.png" caption="Hive stats page showing the varroa trend chart and mood distribution" />
      </section>
      ...
      <section className="help-section">
        ...
        <Screenshot src="/docs/screenshots/hive-stats-overview.png" caption="Varroa trend line chart with inspection dates on the x-axis" />
      </section>
