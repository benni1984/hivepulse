  ...
  return (
    <>
      <section className="help-section">
        ...
        <Screenshot src="/docs/screenshots/inspection-form.png" caption="Inspection form open on a hive, showing all sections" />
      </section>
      ...
      <section className="help-section">
        ...
        <Screenshot src="/docs/screenshots/inspection-form-bottom.png" caption="Saving an inspection — the date and varroa count fields are visible" />
      </section>
