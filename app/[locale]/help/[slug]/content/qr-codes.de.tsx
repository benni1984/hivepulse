  ...
  return (
    <>
      <section className="help-section">
        ...
        <Screenshot caption="QR-Code-Etikett auf einem Bienenstock, bereit zum Scannen" />
      </section>
      ...
      <section className="help-section">
        ...
        <Screenshot caption="QR-Charge-Detailseite mit der Token-Liste und der PDF-Download-Schaltfläche" />
      </section>
      ...
      <section className="help-section">
        ...
        <Screenshot caption="QR-Scanner-Overlay mit einem gescannten Code und dem Bestätigungsblatt" />
      </section>
      ...
      <section className="help-section">
        ...
        <Screenshot caption="Scannen eines Beuten-QR-Codes im Feld — das Volk öffnet sich sofort" />
      </section>
