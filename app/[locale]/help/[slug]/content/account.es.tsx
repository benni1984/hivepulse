  ...
  return (
    <>
      <section className="help-section">
        ...
        <Screenshot src="/docs/screenshots/android-settings-account.png" caption="Sección de perfil en Ajustes mostrando el campo de nombre y el selector de idioma" />
      </section>
