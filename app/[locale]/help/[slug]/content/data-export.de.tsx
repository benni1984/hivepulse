  ...
  return (
    <>
      <section className="help-section">
        ...
        <Screenshot caption="Datenexport-Blatt auf dem Mobilgerät mit Bienenstandauswahl und Formatauswahl" />
      </section>
      ...
      <section className="help-section">
        ...
        <Screenshot caption="Export-Dialog im Web — Bienenstand ausgewählt, CSV-Format gewählt" />
      </section>
