  ...
  return (
    <>
      <section className="help-section">
        ...
        <Screenshot src="/docs/screenshots/hornet-traps-page.png" caption="Trap detail screen showing the access code, catch history, and log-catch button" />
      </section>
      ...
      <section className="help-section">
        ...
        <Screenshot src="/docs/screenshots/hornet-traps-page.png" caption="Register trap form showing name, GPS, and the generated access code" />
      </section>
      ...
      <section className="help-section">
        ...
        <Screenshot src="/docs/screenshots/hornet-traps-page.png" caption="Nearby traps list showing two traps within 50 m, with distances" />
      </section>
