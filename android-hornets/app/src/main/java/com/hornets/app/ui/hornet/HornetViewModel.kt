...
import com.hornets.app.data.api.HornetNestGeoJSON
import com.hornets.app.data.api.HornetSightingOut
...
class HornetViewModel(private val repo: HornetRepository) : ViewModel() {
